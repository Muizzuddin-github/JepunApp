    ...
    <section className="px-5 pt-18 pb-40 bg-coklat_muda">
      <section className="flex flex-col items-center">
        ...
        <section className="text-coklat_tua flex flex-wrap w-3/4 mt-5 justify-around items-center">
          <section className="w-72 mt-10 md:mt-20 text-center">
            ...
            <p className="font-bold text-[24px] md:text-[28px] nicolas">Ruang Tamu</p>
          ...
          <section className="w-72 mt-10 md:mt-20 text-center">
            ...
            <p className="font-bold text-[24px] md:text-[28px] nicolas">Meja Makan</p>
            <p className="text-sm teramo">
          ...
          <section className="w-72 mt-10 md:mt-20 text-center">
            ...
            <p className="font-bold text-[24px] md:text-[28px] nicolas">Ruang Karaoke</p>
            <p className="text-sm teramo">
          ...
          <section className="w-72 mt-10 md:mt-20 text-center">
            ...
            <p className="font-bold text-[24px] md:text-[28px] nicolas">Dapur Bersih</p>
            <p className="text-sm teramo">
          ...
          <section className="w-72 mt-10 md:mt-20 text-center">
            ...
            <p className="font-bold text-[24px] md:text-[28px] nicolas">Spot Foto</p>
            <p className="text-sm teramo">
