...
const Welcome = () => {
  return (
    <section className="mb-40">
      <section className="flex justify-center flex-wrap md:flex-nowrap w-full md:w-3/4 m-auto px-10 md:px-0">
        <section className="w-full flex justify-end py-10 md:py-0">
          <section className="bg-[url('/house.jpeg')] w-full bg-cover bg-no-repeat bg-center h-[30rem] -top-10 relative hidden md:block">
            <Image
        ...
        <section className="w-full bg-gray-300 px-14 pr-5 py-10 h-fit">
          ...
          <section className="mt-14">
            ...
            <section className="mt-12 flex flex-col gap-5 justify-center items-start">
