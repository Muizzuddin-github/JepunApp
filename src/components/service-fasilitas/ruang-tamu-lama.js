        ...
        <>
            <section className="p-1 md:p-4 overflow-hidden flex items-center">
                <section className="grid grid-cols-1 md:grid-cols-2 gap-6 ">
                    ...
                    <section className="text-coklat_tua p-6 flex flex-col justify-center ">
                        <h5
                        ...
                        <section className="p-4 rounded-lg" data-aos="fade-up">
                            ...
                            <Link
                                href={"/contact"}
                                type="button"
                                className="mt-6 text-coklat_muda bg-coklat hover:bg-coklat_tua 
