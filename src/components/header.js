...
const Header = () => {
  return (
    <section className="bg-cover h-screen bg-center bg-no-repeat bg-[url('/house.jpeg')] bg-black/50  bg-blend-multiply">
      <div className="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
        ...
        <p className="mb-8 text-lg text-gray-300 lg:text-xl sm:px-16 lg:px-48 drop-shadow-md font-semibold">
